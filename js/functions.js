...
jQuery($=> {
    ...
    let morphRotatingTextCitation = $("#morph-text-citation");
    if (morphRotatingTextCitation.length) {
        morphRotatingTextCitation.Morphext({
            // The [in] animation type. Refer to Animate.css for a list of available animations.
            animation: "flipInX",
            // An array of phrases to rotate are created based on this separator. Change it if you wish to separate the phrases differently (e.g. So Simple | Very Doge | Much Wow | Such Cool).
            separator: "|",
    ...
    let morphRotatingTextAuthor = $("#morph-text-author");
    if (morphRotatingTextAuthor.length) {
        morphRotatingTextAuthor.Morphext({
            // The [in] animation type. Refer to Animate.css for a list of available animations.
            animation: "flipInX",
            // An array of phrases to rotate are created based on this separator. Change it if you wish to separate the phrases differently (e.g. So Simple | Very Doge | Much Wow | Such Cool).
            separator: "|",
